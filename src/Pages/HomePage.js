...
const Homepage = () => {
  ...
  }, [activeVisible, estadoTexto, estadoTipo, apiEstados, apiServicios]);
  ...
  return (
    <Container fluid className="contenedor-maximo">
      ...
      <Container fluid>
        ...
        <Row md={{ order: 1 }} className="align-items-center mb-1  ">
          ...
          <Col sm={8} lg={8} md={8} xs={12} className='d-none d-sm-flex' >
            <h1>Mapeo de Servicios Colombia</h1>
        ...
        <Row  className="align-items-center d-none d-md-flex">
          ...
          <Col className="d-flex text-center align-items-center col-2" onClick={() => abrirMenuPuntos()}>
            <Col className="col-1">
            ...
            <Col>
              <h2>Mapeo de Servicios Colombia</h2>
            </Col>

          </Col>
          <Col className="d-flex text-left  align-items-center col-2" onClick={() => abrirMenuLineas()}>
            <Col  className="col-1">
      ...
      <Container style={{ margin: '0', padding: '0' }} className="contenedor-maximo-2 mt-1">

        {openLineas ?
          <LineasTelefonicas apiBase={apiBase} />
          : null}
        {openPuntos ?
          <PuntosServicio apiMapeo={apiMaps} activeVisibleP={activeVisible} estadoTextoP={estadoTexto} estadoTipoP={estadoTipo} apiBase={apiBase} apiServicios={apiServicios} apiEstados={apiEstados} />
          : null}

      </Container>


      <Row xs={2} md={4} lg={6} className="align-items-center d-flex d-sm-none menu-position position-absolute">

        <Col onClick={() => abrirMenuPuntos()}>
          <Col>
