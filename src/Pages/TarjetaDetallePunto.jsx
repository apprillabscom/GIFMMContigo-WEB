...
const TarjetaDetallePunto = (item) => {
    ...
    return (
        <>
            <Card style={{ border: '0' }}>
                <Card.Title style={{ borderBottom: '1px solid #E7EAEC' }}>
                    <Row>
                        <Col className='col-8'>
                            {puntoDetalle.Nombre_punto}
                        </Col>
                        <Col>
                            <Button size="xl" variant="boton-llegar" onClick={() => comoLlegar(puntoDetalle.Coordenadas)}>¿Como llegar?</Button>
                        </Col>
                    </Row>
                </Card.Title>
